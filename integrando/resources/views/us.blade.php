...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-4 d-none d-md-block" >
            <br><br><br><br>
            <h1>Lorem Ipsum</h1>

        </div>
        <div class="col-md-12 d-lg-none offset-2" >
            <br><br><br><br>
            <h1>Lorem Ipsum</h1>
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Establecemos contacto con nuestros clientes para programar visitas técnicas</p>
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Realizamos un diagnóstico para identificar las necesidades específicas.</p>
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Diseñamos una propuesta conforme a las necesidades puntuales de nuestros clientes.</p>
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Ponemos en marcha el equipo de humano de Integrando.</p>
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Realizamos seguimiento durante y después de nuestros proyectos.</p>
                    <p><img src="{{'images/nosotros/flecha.svg'}}" alt="" class="img-fluid" style="width: 2%">Los clientes evalúan la satisfacción con nuestros servicios.</p>
                </div>
            </div>
