...
@section('content')
    <div style="background-color:white">
        ...
        <div class="row">
            <div class="col-md-12">
                <br><br><br><br><br>
                <p class="text-justify">1. Diseño e implementación del SGSST <br><br>Servicio que establece la metodología para planear y ejecutar el sistema de gestión de seguridad y salud en el trabajo, conforme al
                    Decreto 1072 de 2015, a las necesidades de los clientes y las características de la organización.</p>
                <p class="text-justify">2. Investigación de accidentes de trabajo <br><br>Servicio que permite descubrir los factores que intervienen en el origen de un accidente de trabajo y sus causas.</p>
                <p class="text-justify">3. Administración del SGSST <br><br>Servicio que permite descubrir los factores que intervienen en el origen de un accidente de trabajo y sus causas.</p>
                <p class="text-justify">4. Diseño y ejecución de programas de promoción y prevención de riesgos laborales <br><br>Servicio de planeación e implementación de los programas que mejoran la calidad de vida de los trabajadores con el fin de prevenir
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <br><br><br><br><br>
                <p class="text-justify">5. Planes de emergencias <br><br>Servicio para la prevención y atención a las amenazas de origen natural, humano y fortuitas.</p>
                <p class="text-justify">6. Plan Estratégico de Seguridad Vial <br><br>Servicio que busca gestionar acciones, mecanismos, estrategias y medidas que debe realizar una organización para prevenir y reducir las tasas de accidentalidad de tránsito. El PESV debe registrarse ante el organismo de transito de jurisdicción de la empresa.</p>
                <p class="text-justify">7. Auditorías al SGSST<br><br>Servicio documentado, sistemático e independiente para vericar la conformidad del sistema de gestión.</p>
                <p class="text-justify">8. Evaluación del SGSST (Revisión por la dirección y Auditorías al SGSST)<br><br>Servicio que permita verificar la conformidad del sistema de gestión de seguridad y salud en el trabajo.</p>
                <p class="text-justify">9. Gestión de las mejoras del SGSST<br><br>Servicio que posibilita la generación de acciones (preventivas, correctivos, acciones correctivas y oportunidades de mejora) para la madurez del sistema de gestión de seguridad y salud en el trabajo.</p>
                <p class="text-justify">10. Educación y capacitación para la promoción y prevención de riesgos laborales<br><br>Servicios de educación informal enfocados en la promoción y prevención de los riesgos laborales conforme a las características de la empresa.</p>
                <br><br><br>
            </div>
        </div>
    </div>
