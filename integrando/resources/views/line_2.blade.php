...
@section('content')
    <div style="background-color:white">
        <main role="main" class="container">
            <div class="row">
                <div class="col-md-12">
                    <br><br><br><br><br>
                    <p class="text-justify"> Diseño, implementación y evaluación del SGSST <br><br>Servicio que establece la metodología para planear, ejecutar y controlar el sistema de gestión de seguridad y salud en el trabajo,
                        conforme al Decreto 1072 de 2015, a las necesidades de los clientes y a las características de la institución.</p>
                    <p class="text-justify">Diseño, implementación y evaluación del SGC <br><br>Servicio que establece la metodología para planear, ejecutar y controlar el sistema de gestión de calidad, conforme a la norma ISO
                        9001:2015, a las necesidades de los clientes y a las características de la institución.</p>
                    <p class="text-justify">Integración de los sistemas de gestión <br><br>Servicio que establece la metodología para definir el conjunto de elementos que interactúan y permiten implantar y alcanzar la
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <br><br>
                <p class="text-justify">Educación informal a la medida <br><br>Servicio educativo que brinda oportunidades para complementar, actualizar, perfeccionar, renovar o profundizar conocimientos,
                    habilidades, técnicas y prácticas. La educación informal no conduce a título alguno o certifícado de aptitud ocupacional.</p>
                <p class="text-justify"> Asesoramiento en calidad educativa<br><br>Contamos con experiencia en el sector educativo, asesorando en temas específicos de los ambientes escolares y fortaleciendo las
                    competencias del talento humano y la gestión educativo.</p>
                <p class="text-justify">Diseño y/o ajuste de proyectos educativos institucionales<br><br>Creamos e intervenimos proyectos educativos institucionales para dar cumplimiento a la Ley conforme a las necesidades
                    institucionales.</p>
